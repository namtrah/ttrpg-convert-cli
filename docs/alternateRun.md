...
2. Install the pre-built release of ttrpg-convert-cli:
    ...
    ```shell
    jbang app install --name ttrpg-convert --force --fresh https://github.com/ebullient/ttrpg-convert-cli/releases/download/2.3.5/ttrpg-convert-cli-2.3.5-runner.jar
    ```
...
2. Download the CLI as a jar
    ...
    - Latest release: [ttrpg-convert-cli-2.3.5-runner.jar](https://github.com/ebullient/ttrpg-convert-cli/releases/download/2.3.5/ttrpg-convert-cli-2.3.5-runner.jar)
...
3. Verify the install by running the command:
    ...
    ```shell
    java -jar ttrpg-convert-cli-2.3.5-runner.jar --help
    ```

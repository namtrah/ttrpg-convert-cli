 ...
 */
@TemplateData
public class QuteDeity extends Open5eQuteBase {
    ...
    public QuteDeity(Open5eSources sources, String name, String source,
    ...
    public String targetFile() {
        return Open5eQuteBase.getDeityResourceName(name, sources().primarySource(), pantheon);
    }
}

 ...
 */
@TemplateData
public class QuteSubclass extends Open5eQuteBase {
    ...
    public QuteSubclass(Open5eSources sources,
    ...
    public String targetFile() {
        return Open5eQuteBase.getSubclassResource(name, parentClass, sources.primarySource());
    }

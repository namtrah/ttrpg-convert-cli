 ...
 */
@TemplateData
public class QuteVehicle extends Open5eQuteBase {
    ...
    /** Vehicle immunities and resistances as {@link dev.ebullient.convert.tools.open5e.qute.ImmuneResist} */
    public final ImmuneResist immuneResist;

    /**
     * Ship capacity and pace attributes as {@link dev.ebullient.convert.tools.open5e.qute.QuteVehicle.ShipCrewCargoPace}.
     */
    ...
    /**
     * Ship sections and traits as {@link dev.ebullient.convert.tools.open5e.qute.QuteVehicle.ShipAcHp} (hull, sails,
     * oars, .. )
     */
    ...
    public static class ShipSection implements QuteUtil {
        /** Name */
        public String name;
        /** Armor class and hit points as {@link dev.ebullient.convert.tools.open5e.qute.QuteVehicle.ShipAcHp} */
        public ShipAcHp acHp;

...
import dev.ebullient.convert.tools.open5e.Open5eIndex.HomebrewMetaTypes;
import dev.ebullient.convert.tools.open5e.PsionicType.PsionicTypeEnum;
import dev.ebullient.convert.tools.open5e.qute.Open5eQuteBase;
import dev.ebullient.convert.tools.open5e.qute.QutePsionic;

public class Json2QutePsionicTalent extends Json2QuteCommon {

    Json2QutePsionicTalent(Open5eIndex index, Open5eIndexType type, JsonNode jsonNode) {

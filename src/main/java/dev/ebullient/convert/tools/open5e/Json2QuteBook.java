...
public class Json2QuteBook extends Json2QuteCommon {
    ...
    public Json2QuteBook(Open5eIndex index, Open5eIndexType type, JsonNode rootNode, JsonNode dataNode) {
     ...
     */
    public List<Open5eQuteNote> buildBook() {
        List<Open5eQuteNote> pages = new ArrayList<>();
            ...
            for (JsonNode x : iterableElements(data)) {
                ...
                try {
                    ...
                    if (!content.isBlank()) {
                        ...
                        Open5eQuteNote note = new Open5eQuteNote(name, titlePage, content, tags)

 ...
 */
@TemplateData
public class QuteItem extends Open5eQuteBase {
    ...
    /** List of magic item variants (as {@link dev.ebullient.convert.tools.open5e.qute.QuteItem.Variant}, optional) */
    public final List<Variant> variants;

    public QuteItem(Open5eSources sources, String name, String source, String detail,

...
import dev.ebullient.convert.tools.open5e.CommonDataTests.TestInput;
...
public class JsonDataSubsetTest {
    ...
    public void testMonsterList() {
        ...
        if (TestUtils.PATH_5E_TOOLS_DATA.toFile().exists()) {
            ...
            Path treeBlight = outputPath
                    ...
                    .resolve(Open5eQuteBase.monsterPath(false, "plant"))
    ...
    public void testRaceList() {
        ...
        if (TestUtils.PATH_5E_TOOLS_DATA.toFile().exists()) {
            final String raceRelative = Open5eIndexType.race.getRelativePath();
